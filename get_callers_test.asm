...
_get_callers_test:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  1d:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  24:	e8 74 03 00 00       	call   39d <get_callers>
  ...
  3e:	e8 5a 03 00 00       	call   39d <get_callers>

    printf(1, "Testing SYS_wait:\n");
  43:	59                   	pop    %ecx
  44:	58                   	pop    %eax
  45:	68 ef 07 00 00       	push   $0x7ef
  4a:	6a 01                	push   $0x1
  4c:	e8 4f 04 00 00       	call   4a0 <printf>
    get_callers(SYS_wait);
  51:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  58:	e8 40 03 00 00       	call   39d <get_callers>

    exit();
  5d:	e8 8b 02 00 00       	call   2ed <exit>
  62:	66 90                	xchg   %ax,%ax
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 58 01 00 00       	call   305 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 1b 01 00 00       	call   32d <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 1e 01 00 00       	call   345 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 e4 00 00 00       	call   315 <close>
  return r;
...
srand(uint s)
{
 ...
 2c6:	5d                   	pop    %ebp
  seed = s;
 2c7:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 2cc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2d0:	69 05 40 0b 00 00 6d 	imul   $0x41c64e6d,0xb40,%eax
 2d7:	4e c6 41 
    + 12345
 2da:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2df:	a3 40 0b 00 00       	mov    %eax,0xb40
    % (1 << 31);
  return seed;
}
 2e4:	c3                   	ret    
...
0000038d <find_largest_prime_factor>:
SYSCALL(find_largest_prime_factor)
 38d:	b8 16 00 00 00       	mov    $0x16,%eax
 392:	cd 40                	int    $0x40
 394:	c3                   	ret    

00000395 <change_file_size>:
SYSCALL(change_file_size)
 395:	b8 17 00 00 00       	mov    $0x17,%eax
 39a:	cd 40                	int    $0x40
 39c:	c3                   	ret    

0000039d <get_callers>:
SYSCALL(get_callers)
 39d:	b8 18 00 00 00       	mov    $0x18,%eax
 3a2:	cd 40                	int    $0x40
 3a4:	c3                   	ret    

000003a5 <get_parent_pid>:
SYSCALL(get_parent_pid)
 3a5:	b8 19 00 00 00       	mov    $0x19,%eax
 3aa:	cd 40                	int    $0x40
 3ac:	c3                   	ret    

000003ad <change_scheduling_queue>:
SYSCALL(change_scheduling_queue)
 3ad:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3b2:	cd 40                	int    $0x40
 3b4:	c3                   	ret    

000003b5 <set_bjf_params_process>:
SYSCALL(set_bjf_params_process)
 3b5:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3ba:	cd 40                	int    $0x40
 3bc:	c3                   	ret    

000003bd <set_bjf_params_system>:
SYSCALL(set_bjf_params_system)
 3bd:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3c2:	cd 40                	int    $0x40
 3c4:	c3                   	ret    

000003c5 <set_bjf_priority>:
SYSCALL(set_bjf_priority)
 3c5:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3ca:	cd 40                	int    $0x40
 3cc:	c3                   	ret    

000003cd <print_process_info>:
SYSCALL(print_process_info)
 3cd:	b8 1f 00 00 00       	mov    $0x1f,%eax
 3d2:	cd 40                	int    $0x40
 3d4:	c3                   	ret    

000003d5 <sem_init>:
SYSCALL(sem_init)
 3d5:	b8 20 00 00 00       	mov    $0x20,%eax
 3da:	cd 40                	int    $0x40
 3dc:	c3                   	ret    

000003dd <sem_acquire>:
SYSCALL(sem_acquire)
 3dd:	b8 21 00 00 00       	mov    $0x21,%eax
 3e2:	cd 40                	int    $0x40
 3e4:	c3                   	ret    

000003e5 <sem_release>:
SYSCALL(sem_release)
 3e5:	b8 22 00 00 00       	mov    $0x22,%eax
 3ea:	cd 40                	int    $0x40
 3ec:	c3                   	ret    
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 46e:	56                   	push   %esi
 46f:	57                   	push   %edi
 470:	e8 98 fe ff ff       	call   30d <write>
  while(--i >= 0)
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e5:	57                   	push   %edi
 4e6:	56                   	push   %esi
 4e7:	e8 21 fe ff ff       	call   30d <write>
 ...
 519:	ff 24 85 0c 08 00 00 	jmp    *0x80c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 53e:	e8 ca fd ff ff       	call   30d <write>
        putc(fd, c);
 ...
 54f:	57                   	push   %edi
 550:	56                   	push   %esi
 551:	e8 b7 fd ff ff       	call   30d <write>
        putc(fd, c);
 ...
 5bb:	57                   	push   %edi
 5bc:	56                   	push   %esi
 5bd:	e8 4b fd ff ff       	call   30d <write>
        while(*s != 0){
 ...
 5fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ff:	e8 09 fd ff ff       	call   30d <write>
        ap++;
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 02 08 00 00       	mov    $0x802,%edx
        while(*s != 0){
 ...
 641:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 44 0b 00 00    	mov    %edx,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
 ...
 733:	e8 3d fc ff ff       	call   375 <sbrk>
  if(p == (char*)-1)
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 48 0b 00 00       	mov    $0xb48,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 7b2:	00 00 00 
    if(p->s.size >= nunits){
