   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 6b 04 00 00       	call   490 <printf>
    exit();
  25:	e8 b3 02 00 00       	call   2dd <exit>
  }
  ...
  32:	e8 06 03 00 00       	call   33d <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 9a 02 00 00       	call   2dd <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 58 01 00 00       	call   2f5 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 1b 01 00 00       	call   31d <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 1e 01 00 00       	call   335 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 e4 00 00 00       	call   305 <close>
  return r;
...
srand(uint s)
{
 ...
 2b6:	5d                   	pop    %ebp
  seed = s;
 2b7:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 2bc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2c0:	69 05 20 0b 00 00 6d 	imul   $0x41c64e6d,0xb20,%eax
 2c7:	4e c6 41 
    + 12345
 2ca:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2cf:	a3 20 0b 00 00       	mov    %eax,0xb20
    % (1 << 31);
  return seed;
}
 2d4:	c3                   	ret    
...
0000037d <find_largest_prime_factor>:
SYSCALL(find_largest_prime_factor)
 37d:	b8 16 00 00 00       	mov    $0x16,%eax
 382:	cd 40                	int    $0x40
 384:	c3                   	ret    

00000385 <change_file_size>:
SYSCALL(change_file_size)
 385:	b8 17 00 00 00       	mov    $0x17,%eax
 38a:	cd 40                	int    $0x40
 38c:	c3                   	ret    

0000038d <get_callers>:
SYSCALL(get_callers)
 38d:	b8 18 00 00 00       	mov    $0x18,%eax
 392:	cd 40                	int    $0x40
 394:	c3                   	ret    

00000395 <get_parent_pid>:
SYSCALL(get_parent_pid)
 395:	b8 19 00 00 00       	mov    $0x19,%eax
 39a:	cd 40                	int    $0x40
 39c:	c3                   	ret    

0000039d <change_scheduling_queue>:
SYSCALL(change_scheduling_queue)
 39d:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3a2:	cd 40                	int    $0x40
 3a4:	c3                   	ret    

000003a5 <set_bjf_params_process>:
SYSCALL(set_bjf_params_process)
 3a5:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3aa:	cd 40                	int    $0x40
 3ac:	c3                   	ret    

000003ad <set_bjf_params_system>:
SYSCALL(set_bjf_params_system)
 3ad:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3b2:	cd 40                	int    $0x40
 3b4:	c3                   	ret    

000003b5 <set_bjf_priority>:
SYSCALL(set_bjf_priority)
 3b5:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3ba:	cd 40                	int    $0x40
 3bc:	c3                   	ret    

000003bd <print_process_info>:
SYSCALL(print_process_info)
 3bd:	b8 1f 00 00 00       	mov    $0x1f,%eax
 3c2:	cd 40                	int    $0x40
 3c4:	c3                   	ret    

000003c5 <sem_init>:
SYSCALL(sem_init)
 3c5:	b8 20 00 00 00       	mov    $0x20,%eax
 3ca:	cd 40                	int    $0x40
 3cc:	c3                   	ret    

000003cd <sem_acquire>:
SYSCALL(sem_acquire)
 3cd:	b8 21 00 00 00       	mov    $0x21,%eax
 3d2:	cd 40                	int    $0x40
 3d4:	c3                   	ret    

000003d5 <sem_release>:
SYSCALL(sem_release)
 3d5:	b8 22 00 00 00       	mov    $0x22,%eax
 3da:	cd 40                	int    $0x40
 3dc:	c3                   	ret    
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 45e:	56                   	push   %esi
 45f:	57                   	push   %edi
 460:	e8 98 fe ff ff       	call   2fd <write>
  while(--i >= 0)
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d5:	57                   	push   %edi
 4d6:	56                   	push   %esi
 4d7:	e8 21 fe ff ff       	call   2fd <write>
 ...
 52e:	e8 ca fd ff ff       	call   2fd <write>
        putc(fd, c);
 ...
 53f:	57                   	push   %edi
 540:	56                   	push   %esi
 541:	e8 b7 fd ff ff       	call   2fd <write>
        putc(fd, c);
 ...
 5ab:	57                   	push   %edi
 5ac:	56                   	push   %esi
 5ad:	e8 4b fd ff ff       	call   2fd <write>
        while(*s != 0){
 ...
 5ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ef:	e8 09 fd ff ff       	call   2fd <write>
        ap++;
...
free(void *ap)
{
 ...
 631:	a1 24 0b 00 00       	mov    0xb24,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 24 0b 00 00    	mov    %edx,0xb24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 24 0b 00 00    	mov    0xb24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 24 0b 00 00    	mov    0xb24,%edi
 ...
 723:	e8 3d fc ff ff       	call   365 <sbrk>
  if(p == (char*)-1)
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 24 0b 00 00    	mov    0xb24,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 24 0b 00 00 28 	movl   $0xb28,0xb24
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 28 0b 00 00       	mov    $0xb28,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 28 0b 00 00 28 	movl   $0xb28,0xb28
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 2c 0b 00 00 00 	movl   $0x0,0xb2c
 7a2:	00 00 00 
    if(p->s.size >= nunits){
