...
main(int argc, char **argv)
{
  ...
  39:	e8 cf 02 00 00       	call   30d <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 93 02 00 00       	call   2dd <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 38 04 00 00       	call   490 <printf>
    exit();
  58:	e8 80 02 00 00       	call   2dd <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
srand(uint s)
{
 ...
 2b6:	5d                   	pop    %ebp
  seed = s;
 2b7:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 2bc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2c0:	69 05 18 0b 00 00 6d 	imul   $0x41c64e6d,0xb18,%eax
 2c7:	4e c6 41 
    + 12345
 2ca:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2cf:	a3 18 0b 00 00       	mov    %eax,0xb18
    % (1 << 31);
  return seed;
}
 2d4:	c3                   	ret    
