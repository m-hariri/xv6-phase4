...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 13 03 00 00       	call   34d <unlink>
...
srand(uint s)
{
 ...
 2d6:	5d                   	pop    %ebp
  seed = s;
 2d7:	a3 50 0b 00 00       	mov    %eax,0xb50
}
 2dc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2e0:	69 05 50 0b 00 00 6d 	imul   $0x41c64e6d,0xb50,%eax
 2e7:	4e c6 41 
    + 12345
 2ea:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2ef:	a3 50 0b 00 00       	mov    %eax,0xb50
    % (1 << 31);
  return seed;
}
 2f4:	c3                   	ret    
 ...
 651:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 54 0b 00 00    	mov    %edx,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 54 0b 00 00    	mov    0xb54,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 58 0b 00 00       	mov    $0xb58,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 7c2:	00 00 00 
    if(p->s.size >= nunits){
