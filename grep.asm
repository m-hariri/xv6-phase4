...
main(int argc, char *argv[])
{
  ...
  55:	e8 bb 05 00 00       	call   615 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 bf 05 00 00       	call   62d <open>
  ...
  81:	e8 1a 07 00 00       	call   7a0 <printf>
      exit();
  86:	e8 62 05 00 00       	call   5ed <exit>
  }
  exit();
  8b:	e8 5d 05 00 00       	call   5ed <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 02 07 00 00       	call   7a0 <printf>
    exit();
  9e:	e8 4a 05 00 00       	call   5ed <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 3b 05 00 00       	call   5ed <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 f8 03 00 00       	call   605 <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 7c 03 00 00       	call   60d <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 58 01 00 00       	call   605 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 1b 01 00 00       	call   62d <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 1e 01 00 00       	call   645 <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 e4 00 00 00       	call   615 <close>
  return r;
...
srand(uint s)
{
 ...
 5c6:	5d                   	pop    %ebp
  seed = s;
 5c7:	a3 34 0f 00 00       	mov    %eax,0xf34
}
 5cc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 5d0:	69 05 34 0f 00 00 6d 	imul   $0x41c64e6d,0xf34,%eax
 5d7:	4e c6 41 
    + 12345
 5da:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 5df:	a3 34 0f 00 00       	mov    %eax,0xf34
    % (1 << 31);
  return seed;
}
 5e4:	c3                   	ret    
...
0000068d <find_largest_prime_factor>:
SYSCALL(find_largest_prime_factor)
 68d:	b8 16 00 00 00       	mov    $0x16,%eax
 692:	cd 40                	int    $0x40
 694:	c3                   	ret    

00000695 <change_file_size>:
SYSCALL(change_file_size)
 695:	b8 17 00 00 00       	mov    $0x17,%eax
 69a:	cd 40                	int    $0x40
 69c:	c3                   	ret    

0000069d <get_callers>:
SYSCALL(get_callers)
 69d:	b8 18 00 00 00       	mov    $0x18,%eax
 6a2:	cd 40                	int    $0x40
 6a4:	c3                   	ret    

000006a5 <get_parent_pid>:
SYSCALL(get_parent_pid)
 6a5:	b8 19 00 00 00       	mov    $0x19,%eax
 6aa:	cd 40                	int    $0x40
 6ac:	c3                   	ret    

000006ad <change_scheduling_queue>:
SYSCALL(change_scheduling_queue)
 6ad:	b8 1a 00 00 00       	mov    $0x1a,%eax
 6b2:	cd 40                	int    $0x40
 6b4:	c3                   	ret    

000006b5 <set_bjf_params_process>:
SYSCALL(set_bjf_params_process)
 6b5:	b8 1c 00 00 00       	mov    $0x1c,%eax
 6ba:	cd 40                	int    $0x40
 6bc:	c3                   	ret    

000006bd <set_bjf_params_system>:
SYSCALL(set_bjf_params_system)
 6bd:	b8 1d 00 00 00       	mov    $0x1d,%eax
 6c2:	cd 40                	int    $0x40
 6c4:	c3                   	ret    

000006c5 <set_bjf_priority>:
SYSCALL(set_bjf_priority)
 6c5:	b8 1e 00 00 00       	mov    $0x1e,%eax
 6ca:	cd 40                	int    $0x40
 6cc:	c3                   	ret    

000006cd <print_process_info>:
SYSCALL(print_process_info)
 6cd:	b8 1f 00 00 00       	mov    $0x1f,%eax
 6d2:	cd 40                	int    $0x40
 6d4:	c3                   	ret    

000006d5 <sem_init>:
SYSCALL(sem_init)
 6d5:	b8 20 00 00 00       	mov    $0x20,%eax
 6da:	cd 40                	int    $0x40
 6dc:	c3                   	ret    

000006dd <sem_acquire>:
SYSCALL(sem_acquire)
 6dd:	b8 21 00 00 00       	mov    $0x21,%eax
 6e2:	cd 40                	int    $0x40
 6e4:	c3                   	ret    

000006e5 <sem_release>:
SYSCALL(sem_release)
 6e5:	b8 22 00 00 00       	mov    $0x22,%eax
 6ea:	cd 40                	int    $0x40
 6ec:	c3                   	ret    
 ...
 6fc:	89 d1                	mov    %edx,%ecx
{
 ...
 76e:	56                   	push   %esi
 76f:	57                   	push   %edi
 770:	e8 98 fe ff ff       	call   60d <write>
  while(--i >= 0)
 ...
 7a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7e5:	57                   	push   %edi
 7e6:	56                   	push   %esi
 7e7:	e8 21 fe ff ff       	call   60d <write>
 ...
 83e:	e8 ca fd ff ff       	call   60d <write>
        putc(fd, c);
 ...
 84f:	57                   	push   %edi
 850:	56                   	push   %esi
 851:	e8 b7 fd ff ff       	call   60d <write>
        putc(fd, c);
 ...
 8bb:	57                   	push   %edi
 8bc:	56                   	push   %esi
 8bd:	e8 4b fd ff ff       	call   60d <write>
        while(*s != 0){
 ...
 8fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8ff:	e8 09 fd ff ff       	call   60d <write>
        ap++;
...
free(void *ap)
{
 ...
 941:	a1 40 13 00 00       	mov    0x1340,%eax
{
 ...
 981:	5b                   	pop    %ebx
  freep = p;
 982:	89 15 40 13 00 00    	mov    %edx,0x1340
}
 988:	5e                   	pop    %esi
 989:	5f                   	pop    %edi
 98a:	5d                   	pop    %ebp
 ...
 9b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9bc:	89 15 40 13 00 00    	mov    %edx,0x1340
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 3d 40 13 00 00    	mov    0x1340,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a1f:	73 4f                	jae    a70 <malloc+0xa0>
    ...
    if(p == freep)
 a21:	8b 3d 40 13 00 00    	mov    0x1340,%edi
 ...
 a33:	e8 3d fc ff ff       	call   675 <sbrk>
  if(p == (char*)-1)
 ...
 a4a:	e8 f1 fe ff ff       	call   940 <free>
  return freep;
 a4f:	8b 15 40 13 00 00    	mov    0x1340,%edx
 ...
 a97:	13 00 00 
    base.s.size = 0;
 a9a:	bf 44 13 00 00       	mov    $0x1344,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 aa9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 aab:	c7 05 48 13 00 00 00 	movl   $0x0,0x1348
 ab2:	00 00 00 
    if(p->s.size >= nunits){
