...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 91 03 00 00       	call   3cd <open>
  ...
  57:	e8 59 03 00 00       	call   3b5 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 24 03 00 00       	call   38d <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 c8 04 00 00       	call   540 <printf>
      exit();
  78:	e8 10 03 00 00       	call   38d <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 01 03 00 00       	call   38d <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 fd 02 00 00       	call   3ad <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 db 02 00 00       	call   3a5 <read>
  ...
  e6:	e8 55 04 00 00       	call   540 <printf>
      exit();
  eb:	e8 9d 02 00 00       	call   38d <exit>
  ...
  f9:	e8 42 04 00 00       	call   540 <printf>
    exit();
  fe:	e8 8a 02 00 00       	call   38d <exit>
...
srand(uint s)
{
 ...
 366:	5d                   	pop    %ebp
  seed = s;
 367:	a3 18 0c 00 00       	mov    %eax,0xc18
}
 36c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 370:	69 05 18 0c 00 00 6d 	imul   $0x41c64e6d,0xc18,%eax
 377:	4e c6 41 
    + 12345
 37a:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 37f:	a3 18 0c 00 00       	mov    %eax,0xc18
    % (1 << 31);
  return seed;
}
 384:	c3                   	ret    
...
free(void *ap)
{
 ...
 6e1:	a1 20 0e 00 00       	mov    0xe20,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 20 0e 00 00    	mov    %edx,0xe20
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 20 0e 00 00    	mov    %edx,0xe20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 20 0e 00 00    	mov    0xe20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 20 0e 00 00    	mov    0xe20,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 20 0e 00 00    	mov    0xe20,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 20 0e 00 00    	mov    %edx,0xe20
}
