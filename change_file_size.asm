...
_change_file_size:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  1c:	57                   	push   %edi
  1d:	57                   	push   %edi
  1e:	68 0c 09 00 00       	push   $0x90c
  23:	6a 01                	push   $0x1
  25:	e8 46 05 00 00       	call   570 <printf>
        exit();
  2a:	e8 8e 03 00 00       	call   3bd <exit>
    }
    char *path = argv[1];
  ...
  32:	8b 70 04             	mov    0x4(%eax),%esi
    int size = atoi(argv[2]);
  35:	ff 70 08             	push   0x8(%eax)
  38:	e8 e3 02 00 00       	call   320 <atoi>
    if (size < 0) {
  ...
  49:	56                   	push   %esi
  4a:	e8 61 00 00 00       	call   b0 <fileSize>
  ...
  53:	89 c7                	mov    %eax,%edi
    if (change_file_size(path, size) < 0) {
  55:	e8 0b 04 00 00       	call   465 <change_file_size>
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	85 c0                	test   %eax,%eax
  5f:	78 32                	js     93 <main+0x93>
  ...
  64:	56                   	push   %esi
  65:	e8 46 00 00 00       	call   b0 <fileSize>

    printf(1, "File size changed from %d to %d\n", prevSize, newSize);
  6a:	50                   	push   %eax
  6b:	57                   	push   %edi
  6c:	68 80 09 00 00       	push   $0x980
  71:	6a 01                	push   $0x1
  ...
  89:	e8 e2 04 00 00       	call   570 <printf>
        exit();
  8e:	e8 2a 03 00 00       	call   3bd <exit>
        printf(1, "change_file_size: cannot change file size\n");
  93:	50                   	push   %eax
  94:	50                   	push   %eax
  95:	68 54 09 00 00       	push   $0x954
  9a:	6a 01                	push   $0x1
  9c:	e8 cf 04 00 00       	call   570 <printf>
        exit();
  a1:	e8 17 03 00 00       	call   3bd <exit>
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
...
int fileSize(char *path) {
  ...
  b3:	56                   	push   %esi
  b4:	53                   	push   %ebx
  b5:	83 ec 28             	sub    $0x28,%esp
  b8:	8b 75 08             	mov    0x8(%ebp),%esi
    int fd = open(path, O_RDWR | O_CREATE);
  bb:	68 02 02 00 00       	push   $0x202
  c0:	56                   	push   %esi
  c1:	e8 37 03 00 00       	call   3fd <open>
    if (fd < 0) {
  c6:	83 c4 10             	add    $0x10,%esp
  c9:	85 c0                	test   %eax,%eax
  cb:	78 30                	js     fd <fileSize+0x4d>
    if (fstat(fd, &st) < 0) {
  cd:	83 ec 08             	sub    $0x8,%esp
  d0:	89 c3                	mov    %eax,%ebx
  d2:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  d5:	50                   	push   %eax
  d6:	53                   	push   %ebx
  d7:	e8 39 03 00 00       	call   415 <fstat>
  dc:	83 c4 10             	add    $0x10,%esp
  df:	85 c0                	test   %eax,%eax
  e1:	78 40                	js     123 <fileSize+0x73>
    if (st.type != T_FILE) {
  e3:	66 83 7d e4 02       	cmpw   $0x2,-0x1c(%ebp)
  e8:	75 26                	jne    110 <fileSize+0x60>
    close(fd);
  ea:	83 ec 0c             	sub    $0xc,%esp
  ed:	53                   	push   %ebx
  ee:	e8 f2 02 00 00       	call   3e5 <close>
}
  f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  f6:	8d 65 f8             	lea    -0x8(%ebp),%esp
  f9:	5b                   	pop    %ebx
  fa:	5e                   	pop    %esi
  fb:	5d                   	pop    %ebp
  fc:	c3                   	ret    
  ...
  fd:	51                   	push   %ecx
  fe:	56                   	push   %esi
  ff:	68 98 08 00 00       	push   $0x898
 104:	6a 01                	push   $0x1
 106:	e8 65 04 00 00       	call   570 <printf>
        exit();
 10b:	e8 ad 02 00 00       	call   3bd <exit>
        printf(1, "change_file_size: %s is not a file\n", path);
 110:	50                   	push   %eax
 111:	56                   	push   %esi
 112:	68 e8 08 00 00       	push   $0x8e8
 117:	6a 01                	push   $0x1
 119:	e8 52 04 00 00       	call   570 <printf>
        exit();
 11e:	e8 9a 02 00 00       	call   3bd <exit>
        printf(1, "change_file_size: cannot stat file %s\n", path);
 123:	52                   	push   %edx
 124:	56                   	push   %esi
 125:	68 c0 08 00 00       	push   $0x8c0
 12a:	6a 01                	push   $0x1
 12c:	e8 3f 04 00 00       	call   570 <printf>
        exit();
 131:	e8 87 02 00 00       	call   3bd <exit>
...
srand(uint s)
{
 ...
 396:	5d                   	pop    %ebp
  seed = s;
 397:	a3 14 0d 00 00       	mov    %eax,0xd14
}
 39c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 3a0:	69 05 14 0d 00 00 6d 	imul   $0x41c64e6d,0xd14,%eax
 3a7:	4e c6 41 
    + 12345
 3aa:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 3af:	a3 14 0d 00 00       	mov    %eax,0xd14
    % (1 << 31);
  return seed;
}
 3b4:	c3                   	ret    
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 00 0a 00 00 	movzbl 0xa00(%edx),%edx
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e9:	ff 24 85 a8 09 00 00 	jmp    *0x9a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba a1 09 00 00       	mov    $0x9a1,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 18 0d 00 00       	mov    0xd18,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 18 0d 00 00    	mov    %edx,0xd18
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 18 0d 00 00    	mov    %edx,0xd18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d 18 0d 00 00    	mov    0xd18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d 18 0d 00 00    	mov    0xd18,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 18 0d 00 00    	mov    0xd18,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 18 0d 00 00    	mov    %edx,0xd18
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 18 0d 00 00 1c 	movl   $0xd1c,0xd18
 867:	0d 00 00 
    base.s.size = 0;
 86a:	bf 1c 0d 00 00       	mov    $0xd1c,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 1c 0d 00 00 1c 	movl   $0xd1c,0xd1c
 876:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 20 0d 00 00 00 	movl   $0x0,0xd20
 882:	00 00 00 
    if(p->s.size >= nunits){
