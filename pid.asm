...
int main(int argc, char* argv[]) {
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    int pid = getpid();
  11:	e8 17 03 00 00       	call   32d <getpid>
  ...
  21:	e8 3a 04 00 00       	call   460 <printf>
    exit();
  26:	e8 82 02 00 00       	call   2ad <exit>
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 58 01 00 00       	call   2c5 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 1b 01 00 00       	call   2ed <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 1e 01 00 00       	call   305 <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 e4 00 00 00       	call   2d5 <close>
  return r;
...
srand(uint s)
{
 ...
 286:	5d                   	pop    %ebp
  seed = s;
 287:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 28c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 290:	69 05 d4 0a 00 00 6d 	imul   $0x41c64e6d,0xad4,%eax
 297:	4e c6 41 
    + 12345
 29a:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 29f:	a3 d4 0a 00 00       	mov    %eax,0xad4
    % (1 << 31);
  return seed;
}
 2a4:	c3                   	ret    
...
0000034d <find_largest_prime_factor>:
SYSCALL(find_largest_prime_factor)
 34d:	b8 16 00 00 00       	mov    $0x16,%eax
 352:	cd 40                	int    $0x40
 354:	c3                   	ret    

00000355 <change_file_size>:
SYSCALL(change_file_size)
 355:	b8 17 00 00 00       	mov    $0x17,%eax
 35a:	cd 40                	int    $0x40
 35c:	c3                   	ret    

0000035d <get_callers>:
SYSCALL(get_callers)
 35d:	b8 18 00 00 00       	mov    $0x18,%eax
 362:	cd 40                	int    $0x40
 364:	c3                   	ret    

00000365 <get_parent_pid>:
SYSCALL(get_parent_pid)
 365:	b8 19 00 00 00       	mov    $0x19,%eax
 36a:	cd 40                	int    $0x40
 36c:	c3                   	ret    

0000036d <change_scheduling_queue>:
SYSCALL(change_scheduling_queue)
 36d:	b8 1a 00 00 00       	mov    $0x1a,%eax
 372:	cd 40                	int    $0x40
 374:	c3                   	ret    

00000375 <set_bjf_params_process>:
SYSCALL(set_bjf_params_process)
 375:	b8 1c 00 00 00       	mov    $0x1c,%eax
 37a:	cd 40                	int    $0x40
 37c:	c3                   	ret    

0000037d <set_bjf_params_system>:
SYSCALL(set_bjf_params_system)
 37d:	b8 1d 00 00 00       	mov    $0x1d,%eax
 382:	cd 40                	int    $0x40
 384:	c3                   	ret    

00000385 <set_bjf_priority>:
SYSCALL(set_bjf_priority)
 385:	b8 1e 00 00 00       	mov    $0x1e,%eax
 38a:	cd 40                	int    $0x40
 38c:	c3                   	ret    

0000038d <print_process_info>:
SYSCALL(print_process_info)
 38d:	b8 1f 00 00 00       	mov    $0x1f,%eax
 392:	cd 40                	int    $0x40
 394:	c3                   	ret    

00000395 <sem_init>:
SYSCALL(sem_init)
 395:	b8 20 00 00 00       	mov    $0x20,%eax
 39a:	cd 40                	int    $0x40
 39c:	c3                   	ret    

0000039d <sem_acquire>:
SYSCALL(sem_acquire)
 39d:	b8 21 00 00 00       	mov    $0x21,%eax
 3a2:	cd 40                	int    $0x40
 3a4:	c3                   	ret    

000003a5 <sem_release>:
SYSCALL(sem_release)
 3a5:	b8 22 00 00 00       	mov    $0x22,%eax
 3aa:	cd 40                	int    $0x40
 3ac:	c3                   	ret    
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 42e:	56                   	push   %esi
 42f:	57                   	push   %edi
 430:	e8 98 fe ff ff       	call   2cd <write>
  while(--i >= 0)
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 21 fe ff ff       	call   2cd <write>
 ...
 4fe:	e8 ca fd ff ff       	call   2cd <write>
        putc(fd, c);
 ...
 50f:	57                   	push   %edi
 510:	56                   	push   %esi
 511:	e8 b7 fd ff ff       	call   2cd <write>
        putc(fd, c);
 ...
 57b:	57                   	push   %edi
 57c:	56                   	push   %esi
 57d:	e8 4b fd ff ff       	call   2cd <write>
        while(*s != 0){
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 09 fd ff ff       	call   2cd <write>
        ap++;
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 98 07 00 00       	mov    $0x798,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6f3:	e8 3d fc ff ff       	call   335 <sbrk>
  if(p == (char*)-1)
