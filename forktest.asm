...
main(void)
{
  ...
  exit();
   b:	e8 8d 03 00 00       	call   39d <exit>
...
00000010 <printf>:
{
  ...
  28:	e8 90 03 00 00       	call   3bd <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	68 a0 04 00 00       	push   $0x4a0
  4e:	e8 5d 01 00 00       	call   1b0 <strlen>
  53:	83 c4 0c             	add    $0xc,%esp
  56:	50                   	push   %eax
  57:	68 a0 04 00 00       	push   $0x4a0
  5c:	6a 01                	push   $0x1
  5e:	e8 5a 03 00 00       	call   3bd <write>
  ...
  7b:	0f 84 83 00 00 00    	je     104 <forktest+0xc4>
    pid = fork();
  81:	e8 0f 03 00 00       	call   395 <fork>
    if(pid < 0)
  ...
  8e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  90:	e8 10 03 00 00       	call   3a5 <wait>
  ...
  if(wait() != -1){
  9e:	e8 02 03 00 00       	call   3a5 <wait>
  a3:	83 f8 ff             	cmp    $0xffffffff,%eax
  a6:	75 49                	jne    f1 <forktest+0xb1>
  write(fd, s, strlen(s));
  a8:	83 ec 0c             	sub    $0xc,%esp
  ab:	68 d2 04 00 00       	push   $0x4d2
  b0:	e8 fb 00 00 00       	call   1b0 <strlen>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	50                   	push   %eax
  b9:	68 d2 04 00 00       	push   $0x4d2
  be:	6a 01                	push   $0x1
  c0:	e8 f8 02 00 00       	call   3bd <write>
}
  c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  c8:	c9                   	leave  
  c9:	c3                   	ret    
      exit();
  ca:	e8 ce 02 00 00       	call   39d <exit>
  write(fd, s, strlen(s));
  cf:	83 ec 0c             	sub    $0xc,%esp
  d2:	68 ab 04 00 00       	push   $0x4ab
  d7:	e8 d4 00 00 00       	call   1b0 <strlen>
  dc:	83 c4 0c             	add    $0xc,%esp
  df:	50                   	push   %eax
  e0:	68 ab 04 00 00       	push   $0x4ab
  e5:	6a 01                	push   $0x1
  e7:	e8 d1 02 00 00       	call   3bd <write>
      exit();
  ec:	e8 ac 02 00 00       	call   39d <exit>
    printf(1, "wait got too many\n");
  f1:	52                   	push   %edx
  f2:	52                   	push   %edx
  f3:	68 bf 04 00 00       	push   $0x4bf
  f8:	6a 01                	push   $0x1
  fa:	e8 11 ff ff ff       	call   10 <printf>
    exit();
  ff:	e8 99 02 00 00       	call   39d <exit>
    printf(1, "fork claimed to work N times!\n", N);
 104:	50                   	push   %eax
 105:	68 e8 03 00 00       	push   $0x3e8
 10a:	68 e0 04 00 00       	push   $0x4e0
 10f:	6a 01                	push   $0x1
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 82 02 00 00       	call   39d <exit>
 ...
 249:	31 db                	xor    %ebx,%ebx
{
 ...
 255:	57                   	push   %edi
 256:	6a 00                	push   $0x0
 258:	e8 58 01 00 00       	call   3b5 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2bd:	e8 1b 01 00 00       	call   3dd <open>
  if(fd < 0)
 ...
 2d1:	50                   	push   %eax
 2d2:	e8 1e 01 00 00       	call   3f5 <fstat>
  close(fd);
 2d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2da:	89 c6                	mov    %eax,%esi
  close(fd);
 2dc:	e8 e4 00 00 00       	call   3c5 <close>
  return r;
...
srand(uint s)
{
 ...
 376:	5d                   	pop    %ebp
  seed = s;
 377:	a3 30 07 00 00       	mov    %eax,0x730
}
 37c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 380:	69 05 30 07 00 00 6d 	imul   $0x41c64e6d,0x730,%eax
 387:	4e c6 41 
    + 12345
 38a:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 38f:	a3 30 07 00 00       	mov    %eax,0x730
    % (1 << 31);
  return seed;
}
 394:	c3                   	ret    
