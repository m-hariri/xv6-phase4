...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 83 02 00 00       	call   2ed <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
srand(uint s)
{
 ...
 2c6:	5d                   	pop    %ebp
  seed = s;
 2c7:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 2cc:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 2d0:	69 05 18 0b 00 00 6d 	imul   $0x41c64e6d,0xb18,%eax
 2d7:	4e c6 41 
    + 12345
 2da:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 2df:	a3 18 0b 00 00       	mov    %eax,0xb18
    % (1 << 31);
  return seed;
}
 2e4:	c3                   	ret    
...
free(void *ap)
{
 ...
 641:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 20 0b 00 00       	mov    $0xb20,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
