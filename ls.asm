...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 7b 05 00 00       	call   5bd <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 e0 0a 00 00       	push   $0xae0
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 69 05 00 00       	call   5bd <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb ac 0e 00 00       	mov    $0xeac,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 ac 0e 00 00       	add    $0xeac,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 e6 04 00 00       	call   5fd <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 e1 04 00 00       	call   615 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 8a 04 00 00       	call   5e5 <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 c3 03 00 00       	call   5d5 <read>
 ...
 313:	e8 cd 02 00 00       	call   5e5 <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 58 01 00 00       	call   5d5 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 1b 01 00 00       	call   5fd <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 1e 01 00 00       	call   615 <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 e4 00 00 00       	call   5e5 <close>
  return r;
...
srand(uint s)
{
 ...
 596:	5d                   	pop    %ebp
  seed = s;
 597:	a3 a8 0e 00 00       	mov    %eax,0xea8
}
 59c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 5a0:	69 05 a8 0e 00 00 6d 	imul   $0x41c64e6d,0xea8,%eax
 5a7:	4e c6 41 
    + 12345
 5aa:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 5af:	a3 a8 0e 00 00       	mov    %eax,0xea8
    % (1 << 31);
  return seed;
}
 5b4:	c3                   	ret    
...
0000065d <find_largest_prime_factor>:
SYSCALL(find_largest_prime_factor)
 65d:	b8 16 00 00 00       	mov    $0x16,%eax
 662:	cd 40                	int    $0x40
 664:	c3                   	ret    

00000665 <change_file_size>:
SYSCALL(change_file_size)
 665:	b8 17 00 00 00       	mov    $0x17,%eax
 66a:	cd 40                	int    $0x40
 66c:	c3                   	ret    

0000066d <get_callers>:
SYSCALL(get_callers)
 66d:	b8 18 00 00 00       	mov    $0x18,%eax
 672:	cd 40                	int    $0x40
 674:	c3                   	ret    

00000675 <get_parent_pid>:
SYSCALL(get_parent_pid)
 675:	b8 19 00 00 00       	mov    $0x19,%eax
 67a:	cd 40                	int    $0x40
 67c:	c3                   	ret    

0000067d <change_scheduling_queue>:
SYSCALL(change_scheduling_queue)
 67d:	b8 1a 00 00 00       	mov    $0x1a,%eax
 682:	cd 40                	int    $0x40
 684:	c3                   	ret    

00000685 <set_bjf_params_process>:
SYSCALL(set_bjf_params_process)
 685:	b8 1c 00 00 00       	mov    $0x1c,%eax
 68a:	cd 40                	int    $0x40
 68c:	c3                   	ret    

0000068d <set_bjf_params_system>:
SYSCALL(set_bjf_params_system)
 68d:	b8 1d 00 00 00       	mov    $0x1d,%eax
 692:	cd 40                	int    $0x40
 694:	c3                   	ret    

00000695 <set_bjf_priority>:
SYSCALL(set_bjf_priority)
 695:	b8 1e 00 00 00       	mov    $0x1e,%eax
 69a:	cd 40                	int    $0x40
 69c:	c3                   	ret    

0000069d <print_process_info>:
SYSCALL(print_process_info)
 69d:	b8 1f 00 00 00       	mov    $0x1f,%eax
 6a2:	cd 40                	int    $0x40
 6a4:	c3                   	ret    

000006a5 <sem_init>:
SYSCALL(sem_init)
 6a5:	b8 20 00 00 00       	mov    $0x20,%eax
 6aa:	cd 40                	int    $0x40
 6ac:	c3                   	ret    

000006ad <sem_acquire>:
SYSCALL(sem_acquire)
 6ad:	b8 21 00 00 00       	mov    $0x21,%eax
 6b2:	cd 40                	int    $0x40
 6b4:	c3                   	ret    

000006b5 <sem_release>:
SYSCALL(sem_release)
 6b5:	b8 22 00 00 00       	mov    $0x22,%eax
 6ba:	cd 40                	int    $0x40
 6bc:	c3                   	ret    
 ...
 6cc:	89 d1                	mov    %edx,%ecx
{
 ...
 73e:	56                   	push   %esi
 73f:	57                   	push   %edi
 740:	e8 98 fe ff ff       	call   5dd <write>
  while(--i >= 0)
 ...
 779:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b5:	57                   	push   %edi
 7b6:	56                   	push   %esi
 7b7:	e8 21 fe ff ff       	call   5dd <write>
 ...
 80e:	e8 ca fd ff ff       	call   5dd <write>
        putc(fd, c);
 ...
 81f:	57                   	push   %edi
 820:	56                   	push   %esi
 821:	e8 b7 fd ff ff       	call   5dd <write>
        putc(fd, c);
 ...
 88b:	57                   	push   %edi
 88c:	56                   	push   %esi
 88d:	e8 4b fd ff ff       	call   5dd <write>
        while(*s != 0){
 ...
 8cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8cf:	e8 09 fd ff ff       	call   5dd <write>
        ap++;
...
free(void *ap)
{
 ...
 911:	a1 bc 0e 00 00       	mov    0xebc,%eax
{
 ...
 951:	5b                   	pop    %ebx
  freep = p;
 952:	89 15 bc 0e 00 00    	mov    %edx,0xebc
}
 958:	5e                   	pop    %esi
 959:	5f                   	pop    %edi
 95a:	5d                   	pop    %ebp
 ...
 989:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 98c:	89 15 bc 0e 00 00    	mov    %edx,0xebc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ac:	8b 3d bc 0e 00 00    	mov    0xebc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ef:	73 4f                	jae    a40 <malloc+0xa0>
    ...
    if(p == freep)
 9f1:	8b 3d bc 0e 00 00    	mov    0xebc,%edi
 ...
 a03:	e8 3d fc ff ff       	call   645 <sbrk>
  if(p == (char*)-1)
 ...
 a1a:	e8 f1 fe ff ff       	call   910 <free>
  return freep;
 a1f:	8b 15 bc 0e 00 00    	mov    0xebc,%edx
 ...
 a4c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a4f:	89 15 bc 0e 00 00    	mov    %edx,0xebc
}
 ...
 a5f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a60:	c7 05 bc 0e 00 00 c0 	movl   $0xec0,0xebc
 a67:	0e 00 00 
    base.s.size = 0;
 a6a:	bf c0 0e 00 00       	mov    $0xec0,%edi
    base.s.ptr = freep = prevp = &base;
 a6f:	c7 05 c0 0e 00 00 c0 	movl   $0xec0,0xec0
 a76:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a79:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a7b:	c7 05 c4 0e 00 00 00 	movl   $0x0,0xec4
 a82:	00 00 00 
    if(p->s.size >= nunits){
